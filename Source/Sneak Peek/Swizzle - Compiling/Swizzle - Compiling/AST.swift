...
public enum AccessLevel: String, CaseIterable {
    /// The refernce can be accessed and mutated in any module
    case `public`
    /// The refernce can be accessed in any module and edited in the defining module
    case `exposed`
